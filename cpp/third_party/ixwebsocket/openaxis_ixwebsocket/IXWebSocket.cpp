...
namespace openaxis_ix
{
        ...
        , _autoThreadName(true)
    {
        _ws.setOnCloseCallback(
            ...
            {
                _onMessageCallback(
                    openaxis_ix::make_unique<WebSocketMessage>(WebSocketMessageType::Close,
                                                      emptyMsg,
                                                      wireSize,
                                                      WebSocketErrorInfo(),
                                                      WebSocketOpenInfo(),
    ...
    WebSocketInitResult WebSocket::connect(int timeoutSecs)
    {
        ...
        _onMessageCallback(openaxis_ix::make_unique<WebSocketMessage>(
                                                   ...
                                                   HttpRequestPtr request)
    {
        ...
        _onMessageCallback(
            openaxis_ix::make_unique<WebSocketMessage>(WebSocketMessageType::Open,
                                              emptyMsg,
                                              0,
                                              WebSocketErrorInfo(),
    ...
    void WebSocket::checkConnection(bool firstConnectionAttempt)
    {
        ...
        while (true)
        {
            ...
            openaxis_ix::WebSocketInitResult status = connect(_handshakeTimeoutSecs);
            ...
            if (!status.success)
            {
                ...
                _onMessageCallback(openaxis_ix::make_unique<WebSocketMessage>(WebSocketMessageType::Error,
                                                                     emptyMsg,
                                                                     0,
                                                                     connectErr,
                                                                     WebSocketOpenInfo(),
        ...
        while (true)
        {
            ...
            _ws.dispatch(
                       ...
                       WebSocketTransport::MessageKind messageKind)
                {
                    ...
                    _onMessageCallback(openaxis_ix::make_unique<WebSocketMessage>(webSocketMessageType,
                                                                         msg,
                                                                         wireSize,
                                                                         webSocketErrorInfo,
                                                                         WebSocketOpenInfo(),
    ...
    ReadyState WebSocket::getReadyState() const
    {
        ...
        {
            case openaxis_ix::WebSocketTransport::ReadyState::OPEN: return ReadyState::Open;
            case openaxis_ix::WebSocketTransport::ReadyState::CONNECTING: return ReadyState::Connecting;
            case openaxis_ix::WebSocketTransport::ReadyState::CLOSING: return ReadyState::Closing;
            case openaxis_ix::WebSocketTransport::ReadyState::CLOSED: return ReadyState::Closed;
